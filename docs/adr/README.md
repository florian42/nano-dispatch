...
- [0002 — Two-step capture injection (stash-and-read)](./0002-two-step-capture-injection.md)
...
- [0005 — Splitter degenerate-case char-split fallback](./0005-splitter-degenerate-fallback.md)
